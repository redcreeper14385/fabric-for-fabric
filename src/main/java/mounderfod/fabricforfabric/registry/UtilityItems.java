...
public class UtilityItems {
    // Repair Kits
    public static final Item IRON_REPAIR_KIT = new Item(new Item.Settings().group(FABRIC_TOOLS).maxCount(1).rarity(Rarity.UNCOMMON));
    public static final Item GOLD_REPAIR_KIT = new Item(new Item.Settings().group(FABRIC_TOOLS).maxCount(1).rarity(Rarity.UNCOMMON));
    public static final Item DIAMOND_REPAIR_KIT = new Item(new Item.Settings().group(FABRIC_TOOLS).maxCount(1).rarity(Rarity.UNCOMMON));
    // Bandage
